...
(function () {
	...
	TCNDDF.setup = function () {
		...
		dropContainer = document.getElementById("top");
		displayContainer = document.getElementById("glyphlist");
	...
	*/
	...
	TCNDDF.buildFontListItem = function (event) {
		...
		var fallback = name + ", UnicodeBMPFallback";
		...
		displayContainer.style.fontFamily = fallback;
		//works! need to update on stylechange
		//displayContainer.setAttribute("style","font-family: " + fallback);
	};
	...
	TCNDDF.updateActiveFont = function (target) {
		...
		var updFallback = getFontFamily + ", UnicodeBMPFallback";

		//displayContainer.style.fontFamily = getFontFamily;
		displayContainer.style.fontFamily = updFallback;
