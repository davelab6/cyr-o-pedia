		...
		*/
		...
		(function(){
			...
			TCNDDF.buildFontListItem = function (event) {
				...
				// Add fallback font
				var fallback = ", 'UnicodeBMPFallback'";
				var fallback2 = " UnicodeBMPFallback";
				// Get font file and prepend it to stylsheet using @font-face rule
				fontFaceStyle = "@font-face{font-family: "+name+", 'UnicodeBMPFallback'; src:url("+data+");}";
				...
				domElements[0].style.fontFamily = name +" 'UnicodeBMPFallback'";
				...
				displayContainer.style.fontFamily = name +" 'UnicodeBMPFallback'";
			};
